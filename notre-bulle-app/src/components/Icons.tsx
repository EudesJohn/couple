// ============================================================
// Icônes SVG — Pas d'emojis, que du style
// ============================================================
...
// Menu (3 points)
export const MoreIcon = ({ size = 24, color = colors.text }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
// Cycle (calendrier avec cœur)
export const CycleIcon = createIcon('M8 2v4 M16 2v4 M3 10h18 M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z M12 15.4l-.9-.9a2.1 2.1 0 0 0-3 3l3.9 3.8 3.9-3.8a2.1 2.1 0 0 0-3-3z');

// Historique (horloge + flèche)
export const HistoryIcon = createIcon('M3 3v5h5 M3.05 13A9 9 0 1 0 6 5.3L3 8 M12 7v5l4 2');

// Téléphone qui sonne
export const PhoneRingIcon = createIcon('M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z M15.54 4.93a5 5 0 0 1 3.53 3.53');
